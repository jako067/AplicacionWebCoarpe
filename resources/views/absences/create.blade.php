    ...
    <div class="card border-0 shadow-sm p-4 border-top border-danger border-3 rounded-3">
        ...
        <form method="POST" action="{{ route('absences.store', $user) }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <label for="fecha" class="form-label text-muted fw-semibold small mb-1">Fecha del Incidente <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('tipo') is-invalid @enderror" name="tipo" id="tipo" value="{{ old('tipo') }}" placeholder="Ej: Ausencia, Retraso, Abandono de puesto...">
                        @error('tipo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-12">
                    <label for="descripcion" class="form-label text-muted fw-semibold small mb-1">Descripción / Motivo Detallado</label>
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id="descripcion" rows="4" placeholder="Escribe aquí los motivos o comentarios adicionales sobre la incidencia del trabajador..."></textarea>
                    @error('descripcion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
