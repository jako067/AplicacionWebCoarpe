        ...
        <div class="card login-card border-0 shadow-sm">
            <div class="card-body p-4 p-sm-5">
                ...
                <div class="text-center mb-4">
                    <div
                        class="logo-box d-inline-flex align-items-center justify-content-center text-white fw-bold mb-3 shadow-sm">
                        C
                    </div>
                ...
                <form action="{{ route('login') }}" method="post">
                    ...
                    <div class="mb-3">
                        <label for="username" class="form-label text-muted fw-semibold small mb-1">Nombre de
                            Usuario:</label>
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" name="username" id="username"
                                value="{{ old('username') }}" placeholder="Ej: 12345678A" required>
                        </div>
                    </div>
