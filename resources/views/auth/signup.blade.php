    ...
    <div class="card register-card border-0 shadow-sm">
        <div class="card-body p-4 p-sm-5">
            ...
            <div class="text-center mb-5">
                ...
                <h2 class="fw-bold mb-1 text-dark">Registro de Usuario</h2>
                <p class="text-muted small">COARPE - Sistema de Gestión Empresarial</p>
            </div>
            ...
            <form action="{{ route('signup') }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label for="name" class="form-label text-muted fw-semibold small mb-1">Nombre Completo</label>
                        <div class="input-group">
                            <span class="input-group-text border-end-0">
                                <i class="bi bi-person"></i>
                            </span>
                            <input type="text" class="form-control border-start-0 ps-0 @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" placeholder="Ej: Juan Pérez" required>
                            @error('name')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <label for="email" class="form-label text-muted fw-semibold small mb-1">Correo Electrónico</label>
                        <div class="input-group">
                            <span class="input-group-text border-end-0">
                    ...
                    <div class="col-md-6">
                        <label for="phone" class="form-label text-muted fw-semibold small mb-1">Número de Teléfono</label>
                        <div class="input-group">
                            <span class="input-group-text border-end-0">
                    ...
                    <div class="col-md-6">
                        <label for="DNI" class="form-label text-muted fw-semibold small mb-1">Número de DNI</label>
                        <div class="input-group">
                            <span class="input-group-text border-end-0">
                                <i class="bi bi-card-text"></i>
                            </span>
                            <input type="text" class="form-control border-start-0 ps-0 @error('DNI') is-invalid @enderror" name="DNI" id="DNI" value="{{ old('DNI') }}" placeholder="Ej: 12345678A" required>
                            @error('DNI')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 mt-3">
                        <label for="password_confirmation" class="form-label text-muted fw-semibold small mb-1">Confirmar Contraseña</label>
                        <div class="input-group">
                            <span class="input-group-text border-end-0">
                ...
                <div class="d-grid mt-4 pt-2">
                    <button type="submit" class="btn btn-login py-2 fw-semibold shadow-sm">Registrarse</button>
                </div>
            </form>

            <div class="text-center mt-4">
                <p class="small text-muted mb-0">¿Ya tienes cuenta? <a href="{{ route('login') }}" class="link-registro fw-semibold text-decoration-none">Inicia sesión aquí</a></p>
            </div>
