                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="bg-white p-3 border rounded-3 shadow-sm d-flex align-items-center">
                                ...
                                <div>
                                    <p class="text-muted fw-semibold small mb-0 text-uppercase tracking-wider" style="font-size: 0.75rem;">Fecha de la jornada</p>
                        ...
                        <div class="col-sm-6">
                            <div class="bg-white p-3 border rounded-3 shadow-sm h-100">
                                <p class="text-muted fw-semibold small mb-2 text-uppercase tracking-wider" style="font-size: 0.75rem;">Hora de Entrada</p>
                                <div class="d-flex align-items-center">
                        ...
                        <div class="col-sm-6">
                            <div class="bg-white p-3 border rounded-3 shadow-sm h-100">
                                <p class="text-muted fw-semibold small mb-2 text-uppercase tracking-wider" style="font-size: 0.75rem;">Hora de Salida</p>
                                <div class="d-flex align-items-center">
            ...
            <div class="card border-0 shadow-sm h-100 bg-verde-oscuro text-white rounded-3 overflow-hidden">
                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <span class="opacity-75 d-flex align-items-center small">
                            <i class="bi bi-stopwatch me-2"></i> Horas Extra
                        </span>
                        @if($task->extra_hours > 0)
                            <span class="badge bg-warning text-dark fs-6 rounded-2 px-2 py-1">+{{ $task->extra_hours }} h</span>
                        @else
                            <span class="fw-medium text-white opacity-50 small">Sin horas extra</span>
                        @endif
                    </div>

                    <div class="mt-auto pt-3 bg-white bg-opacity-10 rounded-3 p-3 text-center border border-white border-opacity-10 shadow-sm">
                        <p class="small mb-1 text-white text-opacity-75 text-uppercase tracking-wider fw-semibold" style="font-size: 0.75rem;">Total Horas Trabajadas</p>
