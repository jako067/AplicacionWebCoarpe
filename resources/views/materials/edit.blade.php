...
@section('title', __('Editar Material'))
...
<div class="container-fluid max-w-4xl">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="fw-bold mb-0 text-dark">{{ __('Editar Material:') }} <span class="text-verde-oscuro">{{ $material->material_name }}</span></h2>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm p-4">
        ...
        <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
            ...
            <h5 class="fw-bold mb-0 text-dark">{{ __('Modificar Datos del Material') }}</h5>
        </div>
        ...
        <form action="{{ route('materials.update', $material->material_id) }}" method="POST">
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-verde-oscuro fw-semibold px-4 shadow-sm">
                    <i class="bi bi-arrow-repeat me-2"></i> {{ __('Actualizar Material') }}
                </button>
            </div>
