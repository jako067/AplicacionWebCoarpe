...
<div class="container-fluid max-w-4xl">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="fw-bold mb-0 text-dark">{{ __('Crear Nuevo Grupo') }}</h2>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('groups.store') }}">
            ...
            <div class="mb-4 pb-3 border-bottom">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h5 class="fw-bold mb-0 text-dark">{{ __('Datos de Identificación') }}</h5>
                </div>

                <div class="row g-3">
                    <div class="col-12">
                        <label for="name" class="form-label text-muted fw-semibold small mb-1">{{ __('Nombre del Grupo') }} <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" placeholder="{{ __('Ej: Cuadrilla de Jardinería / Mantenimiento Norte') }}" required>
                        @error('name')
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="3" placeholder="{{ __('Escribe una breve nota sobre las funciones o la ubicación de este equipo...') }}">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mb-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="fw-bold mb-0 text-dark">{{ __('Seleccionar Miembros de la Plantilla') }}</h5>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-verde-oscuro fw-semibold px-4 shadow-sm">
                    <i class="bi bi-save me-2"></i> {{ __('Guardar Grupo') }}
                </button>
            </div>
