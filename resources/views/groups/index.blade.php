                            ...
                            <tr>
                                <td class="ps-4 py-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="icon-circle-sm bg-light text-secondary rounded shadow-sm d-flex justify-content-center align-items-center flex-shrink-0"
                                ...
                                <td>
                                    <div class="d-flex flex-wrap gap-1">
                                        @forelse ($group->users as $user)
                                            <span
                                                class="badge bg-light text-dark border rounded-pill px-2 py-1 d-inline-flex align-items-center gap-1 fw-medium"
