...
<div class="container-fluid max-w-4xl">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="fw-bold mb-0 text-dark">Nuevo Parte de Trabajo Diario</h2>
        </div>
    </div>

    <div class="card border-0 shadow-sm p-4">
        <h3 class="mb-4 text-center fs-5 text-muted text-uppercase tracking-wider">Formulario de Producción Diaria</h3>
        ...
        <form action="{{ route('daily_work.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control @error('reporte') is-invalid @enderror" name="reporte" id="reporte" rows="5" placeholder="Describe detalladamente las tareas ejecutadas, avances de la obra y rendimiento de la jornada... Layout, hormigonado, excavación, etc.">{{ old('reporte') }}</textarea>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('incidences') is-invalid @enderror" name="incidences" id="incidences" value="{{ old('incidences') }}" placeholder="Ej: Rotura de maquinaria, falta de suministro (dejar vacío si no hay)">
            ...
            <div class="d-flex justify-content-end gap-3">
                ...
                <button type="submit" class="btn btn-verde-oscuro fw-semibold px-4 py-2 shadow-sm">
                    <i class="bi bi-save me-2"></i> Guardar Parte Diario
                </button>
            </div>
