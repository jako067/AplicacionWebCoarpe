...
<div class="container-fluid max-w-4xl">
    ...
    <div class="card border-0 shadow-sm p-4 mb-4">
        ...
        <p class="text-muted mb-4">Gestión unificada de presupuestos, tiempos estimados, personal y materiales.</p>
            ...
            <div class="p-0">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between p-3 border-bottom hover-bg-light transition-all gap-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="icon-circle-sm bg-icon-green-soft rounded-3 shadow-sm d-flex align-items-center justify-content-center flex-shrink-0" style="width: 45px; height: 45px;">
                                <i class="bi bi-file-earmark-text fs-5 text-verde-oscuro"></i>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-wrap gap-2 text-muted small align-items-center">
                                    <span><i class="bi bi-people me-1"></i> {{ $budget->workers_quantity }} Peones</span>
                                    <span>&bull;</span>
                                    @if($budget->staff_quantity > 0)
                                        <span><i class="bi bi-person-badge me-1"></i> {{ $budget->staff_quantity }} Staff</span>
                                        <span>&bull;</span>
                                    @endif
                                    <span><i class="bi bi-clock me-1"></i> {{ $budget->hours_quantity }}h est.</span>
                                </div>
                            </div>
                        </div>

                        <div class="text-md-end text-start mt-2 mt-md-0">
                            <small class="text-muted d-block mb-1">Total Presupuesto</small>
                ...
                @empty
                    <div class="text-center py-5 text-muted">
                        ...
                        <a href="{{ route('budgets.create') }}" class="btn btn-sm btn-outline-success mt-3fw-medium">Crear el primero</a>
                    </div>
                @endforelse
            </div>
        </div>
