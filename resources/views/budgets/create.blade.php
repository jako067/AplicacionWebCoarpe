                        ...
                        <div class="card border-0 shadow-sm p-4 h-100 bg-light bg-opacity-50 border border-primary border-opacity-10">
                            ...
                            <div class="mb-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <p class="text-muted small fw-semibold text-uppercase mb-0">Añadir del inventario</p>
...
<script>
    // Control visual del formulario colapsable de nuevo material
    ...
    // Índice dinámico para construir el array asociativo en la Request de Laravel
    let materialIndex = 1;
    ...
    function agregarFilaMaterial() {
        ...
        // Estructura idéntica inyectando de forma dinámica el índice correlativo
        nuevaFila.innerHTML = `
            <div class="col-8">
    ...
    // Eliminación de nodos del DOM mediante delegación local
